...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      aG: x0 => x0.x,
      aH: x0 => x0.next(),
      aI: (x0,x1) => x0.getModifierState(x1),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      kI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      l: (a, i) => a[i],
      ...
      xI: (x0,x1) => new OffscreenCanvas(x0,x1),
      y: (a, i, v) => a[i] = v,
